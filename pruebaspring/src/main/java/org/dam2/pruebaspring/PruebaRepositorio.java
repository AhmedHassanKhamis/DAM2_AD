...
public class PruebaRepositorio implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		System.out.println(alumnoDAO.subirPunto(4));
		
		alumnoDAO.listadoAlumnos().forEach(o -> System.out.println(o.getNia() + "->" + o.getNombre()));
		
		alumnoDAO.findByNombre("a1").forEach(o -> System.out.println(o.getNia() + "->" + o.getNombre()));
