...
public class CSVToTelefono extends AbstractCsvConverter{
...
StringReader stringReader = new StringReader(value);
		...
		CSVParser icsvParser = new CSVParserBuilder().
							withSeparator('/'). // campos del Telefono separados por /
							build();
        ...
        return new CsvToBeanBuilder<Telefono>(csvReader).
                                withType(Telefono.class).
                                build().
                                stream().
                                findFirst().
                                orElseGet(Telefono::new);// devolver el Telefono leído o vacío
